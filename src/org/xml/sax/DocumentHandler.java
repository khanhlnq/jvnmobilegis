 ...
 * endElement event.
 * </p>
 * <p/> Application writers who do not want to implement the entire interface
 * can derive a class from HandlerBase, which implements the default
...
public interface DocumentHandler {
     ...
     * information.
     * </p>
     * <p/> The application must not attempt to read from the array outside of
     * the specified range.
     * </p>
