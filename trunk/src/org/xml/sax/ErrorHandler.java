 ...
 * </p>
 * <p/> The parser shall use this interface instead of throwing an exception: it
 * is up to the application whether to throw an exception for different types of
 ...
 * other words, a SAX driver class could catch an exception and report a
 * fatalError).
 * </p>
 ...
 * SAXParseException for fatal errors. An application may extend that class
