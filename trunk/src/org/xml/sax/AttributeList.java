 ...
 * <p/>
 * The SAX parser implements this interface and passes an instance to the SAX application as the second argument of each
 * startElement event.
 * </p>
 * <p/>
 * The instance provided will return valid results only during the scope of the startElement invocation (to save it for
 * future use, the application must make a copy: the AttributeListImpl helper class provides a convenient constructor
 * for doing so).
 * </p>
 * <p/>
 * An AttributeList includes only attributes that have been specified or defaulted: #IMPLIED attributes will not be
 * included.
 * </p>
 * <p/>
 * There are two ways for the SAX application to obtain information from the AttributeList. First, it can iterate
...
public interface AttributeList {
     ...
     * <p/>
     * The SAX parser may provide attributes in any arbitrary order, regardless of the order in which they were declared
     * or specified. The number of attributes may be zero.
     * </p>
     *
     ...
     * <p/>
     * The names must be unique: the SAX parser shall not include the same attribute twice. Attributes without values
     * (those declared #IMPLIED without a value specified in the start tag) will be omitted from the list.
     * </p>
     * <p/>
     ...
     * then it must return the value "CDATA" as stated in the XML 1.0 Recommentation (clause 3.3.3, "Attribute-Value
     * Normalization").
     * </p>
     * <p/>
     ...
     * a single string separated by whitespace.
     * </p>
     *
     * @param i The index of the attribute in the list (starting at 0).
