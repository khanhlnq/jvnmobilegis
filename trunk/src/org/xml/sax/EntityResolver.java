 ...
 * </p>
 * <p/> The parser will then allow the application to intercept any external
 ...
 * URI types other than URLs.
 * </p>
 * <p/> The following resolver would provide the application with a special
 ...
 * by using the public identifier).
 * </p>
 * <p/> The HandlerBase class implements the default behaviour for this
 * interface, which is simply always to return null (to request that the parser
